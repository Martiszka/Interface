...
Interface1::Interface1(){
	...
	pid->createList();
	pid->addToSubList(new Parameter("P" , 20 , "kp" , 0));
	pid->addToSubList(new Parameter("I" , 20 , "ki" , 0));
	pid->addToSubList(new Parameter("D" , 20 , "kd" , 0));
	list_of_elements->addParameter(pid);
	//pid = new Parameter("pid", 20, "pid", 0);
